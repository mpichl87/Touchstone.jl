...
# String:
@test write_touchstone_string( parse_touchstone_string( fourportstring, 4 ) ) == fourportstring
@test parse_touchstone_string( write_touchstone_string( fourportdata ), 4 ) == fourportdata
